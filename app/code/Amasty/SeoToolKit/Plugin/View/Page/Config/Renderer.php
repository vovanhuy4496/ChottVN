...
namespace Amasty\SeoToolKit\Plugin\View\Page\Config;
...
class Renderer
{
    const CACHE_KEY = 'amasty_seotoolkit_should_load_css_file';
    ...
    public function beforeRenderAssets(
        ...
        if ($shouldLoad) {
            $this->config->addPageAsset('Amasty_SeoToolKit::css/source/mkcss/amseokit.css');
        }
