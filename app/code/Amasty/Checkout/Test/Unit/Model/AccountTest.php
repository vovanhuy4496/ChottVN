...
class AccountTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->billing = $this->createPartialMock(\Magento\Sales\Model\Order\Address::class, ['setCustomerDob']);
    ...
    public function testCreate()
    {
        ...
        $this->billing->expects($this->once())->method('setCustomerDob');
    ...
    public function testCreateCustomerIsLoggedIn()
    {
        ...
        $this->billing->expects($this->never())->method('setCustomerDob');
