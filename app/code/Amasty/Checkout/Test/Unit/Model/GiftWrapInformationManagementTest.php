...
class GiftWrapInformationManagementTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testUpdate()
    {
        ...
        $store = $this->createPartialMock(\Magento\Store\Model\Store::class, ['getBaseCurrency', 'getCurrentCurrency', 'getRate']);
        ...
        $store->expects($this->any())->method('getRate')->willReturn(1);
