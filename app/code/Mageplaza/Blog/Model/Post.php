...
use Magento\Catalog\Model\ResourceModel\Category\CollectionFactory as CategoryCatalogCollectionFactory;
/**
...
class Post extends AbstractModel
{
    ...
    public function __construct(
        ...
        CategoryCatalogCollectionFactory $catalogCollectionFactory,
     ...
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    public function getCatalogCaIds()
    {
        if (!$this->hasData('catalogca_ids')) {
            $ids = $this->_getResource()->getCatalogCaIds($this);

            $this->setData('catalogca_ids', $ids);
        }
        return (array)$this->_getData('catalogca_ids');
    }
    /**
     * @return array
     * @throws \Magento\Framework\Exception\LocalizedException
