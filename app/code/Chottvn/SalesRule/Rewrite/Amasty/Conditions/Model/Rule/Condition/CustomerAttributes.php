...
namespace Chottvn\SalesRule\Rewrite\Amasty\Conditions\Model\Rule\Condition;
 ...
 */
class CustomerAttributes extends \Amasty\Conditions\Model\Rule\Condition\CustomerAttributes
{
    ...
    /**
     * @var \Chottvn\SalesRule\Model\Customer\Attribute\Source\Group
     */
    ...
    public function __construct(
        ...
        \Chottvn\SalesRule\Model\Customer\Attribute\Source\Group $customerGroupSource,
        array $data = []
    ) {       
        $this->resource = $resource;
        $this->customerFactory = $customerFactory;
        $this->customerSession = $customerSession;
        parent::__construct($context, $resource, $customerFactory, $customerSession, $address, $data);              
    ...
    private function addSpecialAttributes(array &$attributes)
    {
        ...
        $attributes['group_id'] = __('Customer Group ID');
    ...
    public function getValueElementType()
    {
        ...
        if ($this->getAttribute() === 'entity_id' || $this->getAttribute() === 'membership_days' // || $this->getAttribute() === 'group_id'
        ) {
            return 'text';
        }
    ...
    public function getValueSelectOptions()
    {
        ...
        if (is_object($attributeObject) && $attributeObject->usesSource()) {
            ...
            if (get_class( $attributeObject->getSource() ) == 'Magento\Customer\Model\Customer\Attribute\Source\Group' ){
                $selectOptions = $this->customerGroupSource->getAllOptions();
            }else{
