...
use Chottvn\Inventory\Api\Data\LogSearchResultsInterfaceFactory;
use Chottvn\Inventory\Api\LogRepositoryInterface;
use Chottvn\Inventory\Model\ResourceModel\Log as ResourceLog;
use Chottvn\Inventory\Model\ResourceModel\Log\CollectionFactory as LogCollectionFactory;
...
class LogRepository implements LogRepositoryInterface
{
    ...
    public function save(
        ...
        $logData = $this->extensibleDataObjectConverter->toNestedArray(
            $log,
            [],
            \Chottvn\Inventory\Api\Data\LogInterface::class
        );
