...
class Edit extends \Chottvn\Inventory\Controller\Adminhtml\Log
{
    /**
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Chottvn_Inventory::log_update';
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\Chottvn\Inventory\Model\Log::class);
        ...
        $this->_coreRegistry->register('chottvn_inventory_log', $model);
