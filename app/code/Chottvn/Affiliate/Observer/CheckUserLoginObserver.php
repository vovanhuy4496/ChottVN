...
class CheckUserLoginObserver implements ObserverInterface
{
    ...
    {
        $this->writeLog('Magento\Captcha\Observer::excute - begin');
        $formId = 'user_login';
        ...
        if ($captchaModel->isRequired($login)) {
            ...
            if (!$captchaModel->isCorrect($word)) {
                ...
                $url = $beforeUrl ? $beforeUrl : $this->urlModel->getUrl('affiliate/account/login', ['_secure' => true]);
    ...
    {
        $writer = new \Zend\Log\Writer\Stream(BP . '/var/log/captcha_login.log');
