...
abstract class Index extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        $this->_dateTimeFactory = $dateTimeFactory ?: $objectManager->get(DateTimeFactory::class);
    ...
    protected function actUponMultipleCustomers(callable $singleAction, $customerIds)
    {
        if (!is_array($customerIds)) {
            $this->messageManager->addError(__('Please select affiliate(s).'));
            return 0;
        }
        $customersUpdated = 0;
     ...
     * @return int
     */
    public function getLinkExpirationPeriod()
    {
        return $this->_scopeConfig->getValue(Customer::XML_PATH_CUSTOMER_RESET_PASSWORD_LINK_EXPIRATION_PERIOD).'h';
    }
}
