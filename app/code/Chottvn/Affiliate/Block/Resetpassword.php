...
class Resetpassword extends \Magento\Customer\Block\Account\Resetpassword
{
	...
	public function getActiveAffiliateMessage() {
		$message = $this->_coreSession->getActiveAffiliateMessage();
		return ($message) ? $message : __('Please input OTP code we have just sent to your phone number');
	}
}
