...
namespace Chottvn\Affiliate\Block\Form;
...
class Login extends \Magento\Customer\Block\Form\Login
{
     ...
     * @return string
     */
    public function getAffiliatePostActionUrl()
    {
        return str_replace("customer", "affiliate", $this->getPostActionUrl());
    }
     ...
     * @return string
     */
    public function getAffiliateForgotPasswordUrl()
    {
        return str_replace("customer", "affiliate", $this->getForgotPasswordUrl());
    }
}
