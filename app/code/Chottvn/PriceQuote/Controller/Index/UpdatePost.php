 ...
 */
class UpdatePost extends \Magento\Framework\App\Action\Action implements HttpGetActionInterface, HttpPostActionInterface
{
    /**
    ...
    public function checkDefaultStockPromo($product, $requestQty, $qtyProduct)
    {
        try {
            ...
            // $this->writeLog($defaultStockQty);
            // $this->writeLog('$requestQty');
            // $this->writeLog($requestQty);
            // $this->writeLog('$qtyProduct');
            // $this->writeLog($qtyProduct);
            // $this->writeLog('$getDefaultStockCustom');
            // $this->writeLog($getDefaultStockCustom);
            // $this->writeLog('$sumQtyCurrentInQuoteItem');
            // $this->writeLog($sumQtyCurrentInQuoteItem);
            ...
            // $this->writeLog('$defaultStock');
            // $this->writeLog((int) $defaultStock);
    ...
    public function execute()
    {
        ...
        $this->writeLog('Before - $this->_goBack()');
        return $this->_goBack();
    }
    ...
    */
    private function writeLog($info, $type = "info") {
        $writer = new \Zend\Log\Writer\Stream(BP . '/var/log/update_qty_bg.log');
