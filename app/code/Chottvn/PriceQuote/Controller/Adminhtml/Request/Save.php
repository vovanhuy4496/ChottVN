...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\Chottvn\PriceQuote\Model\Request::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('chottvn_pricequote_request');
            ...
            $this->dataPersistor->set('chottvn_pricequote_request', $data);
