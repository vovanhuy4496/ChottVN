...
namespace Chottvn\SigninPhoneNumber\Rewrite\Magento\Customer\Controller\Ajax;

use Chottvn\SigninPhoneNumber\Exception\NotCustomerAccountException;
...
class Login extends \Magento\Framework\App\Action\Action implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        // } catch (NotCustomerAccountException $e) {
        //     $response = [
        //         'errors' => true,
        //         'message' => $e->getMessage(),
        //     ];
        ...
        //     ];
            ...
            $customer = $accountManagement->getCustomerRepository($credentials['username']);
            $getAuthenticationCTT = $accountManagement->getAuthenticationCTT($customer->getId(), $credentials['password']);
