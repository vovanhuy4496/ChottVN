...
namespace Chottvn\Address\Block\Adminhtml\Importaddress\Edit;
...
class Form extends Generic
{
    ...
    {
        parent::_construct();
        $this->setId('import_address_form');
        ...
        $fieldset->addField(
            ...
            [
                ...
                'after_element_html' => '
                    <ul>
                        <li>
                            <a href="'.$this->getUrl('*/*/sampleCsv', ['code' => 'region']).'">
                                ' . __('sample_region.csv') . '
                            </a>
                        </li>
                        <li>
                            <a href="'.$this->getUrl('*/*/sampleCsv', ['code' => 'city']).'">
                                ' . __('sample_city.csv') . '
                            </a>
                        </li>
                        <li>
                            <a href="'.$this->getUrl('*/*/sampleCsv', ['code' => 'township']).'">
                            ' . __('sample_township.csv') . '
                            </a>
                        </li>
                    </ul>
                '
