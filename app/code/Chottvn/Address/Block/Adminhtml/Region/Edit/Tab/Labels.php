...
namespace Chottvn\Address\Block\Adminhtml\Region\Edit\Tab;
    ...
    \Magento\Ui\Component\Layout\Tabs\TabInterface
{
    ...
    {
        $currentRegion = $this->_coreRegistry->registry('address_region');

        if (!$currentRegion) {
            $id = $this->getRequest()->getParam('region_id');
            $currentRegion = $this->regionFactory->create();
            $currentRegion->load($id);
        }

        /** @var \Magento\Framework\Data\Form $form */
        $form = $this->_formFactory->create();
        $labels = $currentRegion->getStoreLabels();
