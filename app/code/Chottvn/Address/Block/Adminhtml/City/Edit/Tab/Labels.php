...
namespace Chottvn\Address\Block\Adminhtml\City\Edit\Tab;
    ...
    \Magento\Ui\Component\Layout\Tabs\TabInterface
{
    ...
    {
        $currentCity = $this->_coreRegistry->registry('address_city');

        if (!$currentCity) {
            $id = $this->getRequest()->getParam('city_id');
            $currentCity = $this->cityFactory->create();
            $currentCity->load($id);
        }

        /** @var \Magento\Framework\Data\Form $form */
        $form = $this->_formFactory->create();
        $labels = $currentCity->getStoreLabels();
