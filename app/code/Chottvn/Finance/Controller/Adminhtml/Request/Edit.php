...
class Edit extends \Chottvn\Finance\Controller\Adminhtml\Request
{
    /**
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\Chottvn\Finance\Model\Request::class);
        ...
        $this->_coreRegistry->register('chottvn_finance_request', $model);
