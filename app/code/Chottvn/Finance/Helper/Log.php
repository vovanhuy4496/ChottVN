...
class Log extends  AbstractHelper
{
    ...
    public function __construct(
        Context $context,
        \Chottvn\Finance\Model\LogFactory $logFactory,
    ...
    public function saveLogWithResource($data)
    {
        try{
            ...
            $log = $objectManager->create('Chottvn\Finance\Model\Log');
            $log->setData([
    ...
    {
        $writer = new \Zend\Log\Writer\Stream(BP . '/var/log/log_finance.log');
