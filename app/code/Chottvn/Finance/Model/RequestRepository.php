...
use Chottvn\Finance\Api\Data\RequestSearchResultsInterfaceFactory;
use Chottvn\Finance\Api\RequestRepositoryInterface;
use Chottvn\Finance\Model\ResourceModel\Request as ResourceRequest;
use Chottvn\Finance\Model\ResourceModel\Request\CollectionFactory as RequestCollectionFactory;
...
class RequestRepository implements RequestRepositoryInterface
{
    ...
    public function save(
        \Chottvn\Finance\Api\Data\RequestInterface $request
    ) {
        ...
        $requestData = $this->extensibleDataObjectConverter->toNestedArray(
            $request,
            [],
            \Chottvn\Finance\Api\Data\RequestInterface::class
        );
