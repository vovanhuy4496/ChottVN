...
use Chottvn\Finance\Api\Data\TransactionSearchResultsInterfaceFactory;
use Chottvn\Finance\Api\TransactionRepositoryInterface;
use Chottvn\Finance\Model\ResourceModel\Transaction as ResourceTransaction;
use Chottvn\Finance\Model\ResourceModel\Transaction\CollectionFactory as TransactionCollectionFactory;
...
class TransactionRepository implements TransactionRepositoryInterface
{
    ...
    public function save(
        ...
        $transactionData = $this->extensibleDataObjectConverter->toNestedArray(
            $transaction,
            [],
            \Chottvn\Finance\Api\Data\TransactionInterface::class
        );
