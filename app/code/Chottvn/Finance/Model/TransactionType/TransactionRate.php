...
class TransactionRate extends \Magento\Eav\Model\Entity\Attribute\Source\AbstractSource
{
    ...
    public function getAllOptions()
    {
        if ($this->_options === null) {
            ...
            foreach ($collection as $item) {
                $getData = ['value' => $item["transactiontype_id"], 'label' => $item["rate"], 'sort' => $item["transactiontype_id"]];
                // var_dump($getData);
