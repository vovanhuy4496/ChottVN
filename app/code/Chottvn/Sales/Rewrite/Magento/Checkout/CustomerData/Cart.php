...
namespace Chottvn\Sales\Rewrite\Magento\Checkout\CustomerData;
...
class Cart extends \Magento\Checkout\CustomerData\Cart
{
    ...
    protected function getSummaryCount()
    {
        ...
        $itemCount = 0;
        $items = $quoteFactory->create()->addFieldToFilter('quote_id', $quote->getId())
                                        ->addFieldToFilter('cart_promo_option', array('null' => true))
	...
	*/
	private function writeLog($info, $type = "info") {
		$writer = new \Zend\Log\Writer\Stream(BP . '/var/log/Minicart.log');
