define([
    ...
    return {
        ...
        checkDependencies: function() {
            // neu khoi tao la check, thi tien hanh unCheck
            // initialOptions[2].value = unCheck
            if (this.initialOptions[2].value != this.initialValue) {
                this.initialValue = this.initialOptions[2].value;
                this.checked._latestValue = false;
            }
            if (this.relations && this.relations.length) {
                ...
                registry.async(this.parentName)(function(fieldset) {
                    this.relations.map(function(relation) {
                        registry.async(fieldset.name + '.' + relation.dependent_name)(function(dependElement) {
                            if (this.isCanShow(relation) && this.checked._latestValue) {
                                listDisplayedUID.push(this.uid);
                                this.showDepend(dependElement);
                                this.initialValue = this.initialOptions[1].value;
                            } else {
                                ...
                                this.value._latestValue = this.initialValue;
                            }
                        }.bind(this));
                    }.bind(this));
                }.bind(this));
