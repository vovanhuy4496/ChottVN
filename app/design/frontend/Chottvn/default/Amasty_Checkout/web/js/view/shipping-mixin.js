    ...
    function(
        ...
        return function(Shipping) {
            return Shipping.extend({
                 ...
                 * @param {Object} oldMethod Previous payment method
                 * @returns {void}
                 */
                    ...
                    if (!loggedIn) {
                        registry.get('checkout.steps.shipping-step.shippingAddress', function(component) {
                            if (component.isSelected()) {
                                component.selectShippingMethod.valueHasMutated();
                            }
                        });
                    }
                },
                ...
                shippingAddressObserver: function() {
                    ...
                    if (shippingService.isLoading()) {
                        ...
                        saveSubscription = shippingService.isLoading.subscribe(function(isLoading) {
                            if (!isLoading) {
                ...
                getNameInfoCustomer: function() {
                    return window.checkoutConfig.quoteData.block_info.block_customer_info.value;
                },

                getNameVatInvoiceRequired: function() {
                    return window.checkoutConfig.quoteData.block_info.block_vat_invoice_required.value;
                },
