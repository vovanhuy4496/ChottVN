define([
    ...
    'mage/translate',
    'domReady!'
], function($, ko, _, quote, validationRules, formPopUpState, addressFormState, paymentLoader, validator, $t) {
    'use strict';
    ...
    return {
        ...
        hideCustomField: function() {
            ...
            if (checked_vat_ctt) {
                $('input[name="vat_invoice_required_ctt"]').prop("checked", false);
        ...
        register: function(address) {
            ...
            var checked = $('input[name="others_receive_products"]').is(':checked');
            if (checked) {
                address.email = $('input[name="others_email"]').val();
                address.firstname = $('input[name="others_fullname"]').val();
                address.telephone = $('input[name="others_telephone"]').val();
            }
