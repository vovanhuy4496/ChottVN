...
define([
    ...
    $.widget('mage.productListToolbarForm', $.mage.productListToolbarForm, {
        options:
        {
            ...
            productsListBlockListingTabs: '.box-div-category-search-products',
            productsListBlockListingTabsConfig: '.box-div-category-search-products .catalog-product-list #ajax_listingtabs_config',
            productsListBlockListingTabsLoading: '.box-div-category-search-products .catalog-product-list .ltabs-loading-css-focus .ltabs-loading-css',
            productsListBlockListingTabsInnerContent: '.box-div-category-search-products .catalog-product-list .products-grid',
            productsListBlockListingTabsContent: '.box-div-category-search-products .catalog-product-list',
        ...
        _bind: function (element, paramName, defaultValue) {
            var sorter_element = '';
            if (typeof($(this.options.orderControl).get(0)) != "undefined"){
                sorter_element = $(this.options.orderControl).get(0).id;
            }else{
                sorter_element = 'undefined';
            }
