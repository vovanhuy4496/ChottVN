...
return [
    'modules' => [
        ...
        'Chottvn_AccountLock' => 1,
        'Chottvn_Address' => 1,
        'Chottvn_Affiliate' => 1,
        'Chottvn_AutoApprovedReview' => 1,
        'Chottvn_Backend' => 1,
        'Chottvn_Blog' => 1,
        'Chottvn_Brand' => 1,
        'Chottvn_Captcha' => 1,
        'Chottvn_ConfigurableProduct' => 1,
        'Chottvn_Contact' => 1,
        'Chottvn_Core' => 1,
        'Chottvn_Coupon' => 1,
        'Chottvn_CustomCatalog' => 1,
        'Chottvn_CustomCatalogSearch' => 1,
        'Chottvn_CustomReview' => 1,
        'Chottvn_Customer' => 1,
        'Chottvn_CustomerMembership' => 1,
        'Chottvn_DataFeed' => 1,
        'Chottvn_EmailAttachment' => 1,
        'Chottvn_Finance' => 1,
        'Chottvn_Frontend' => 1,
        'Chottvn_Inventory' => 1,
        'Chottvn_Notification' => 1,
        'Chottvn_OfflineShipping' => 1,
        'Chottvn_OrderPayment' => 1,
        'Chottvn_PaymentAccount' => 1,
        'Chottvn_PriceComparison' => 1,
        'Chottvn_PriceDecimal' => 1,
        'Chottvn_PriceQuote' => 1,
        'Chottvn_Rma' => 1,
        'Chottvn_Sales' => 1,
        'Chottvn_SalesRule' => 1,
        'Chottvn_SeoRichData' => 1,
        'Chottvn_SeoToolKit' => 1,
        'Chottvn_SigninPhoneNumber' => 1,
        'Chottvn_Sitemap' => 1,
        'Chottvn_Sms' => 1,
        'Chottvn_StockAlert' => 1,
        'Chottvn_StorePickupShipping' => 1,
